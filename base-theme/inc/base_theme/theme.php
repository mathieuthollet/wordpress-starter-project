...
class Theme
{
    ...
    public static function wp_enqueue_scripts()
    {
        ...
        // CSS spécifiques
        wp_enqueue_style('base-theme', get_stylesheet_directory_uri() . '/assets/css/style.dist' . (BASE_THEME_MODE_DEV ? '' : '.min') . '.css?v=' . BASE_THEME_VERSION_JS_CSS);
        wp_enqueue_style('base-theme-print', get_stylesheet_directory_uri() . '/assets/css/print.dist' . (BASE_THEME_MODE_DEV ? '' : '.min') . '.css?v=' . BASE_THEME_VERSION_JS_CSS, [], false, 'print');
        // JS spécifiques
        wp_enqueue_script('base-theme', get_stylesheet_directory_uri() . '/assets/js/base-theme.dist' . (BASE_THEME_MODE_DEV ? '' : '.min') . '.js?v=' . BASE_THEME_VERSION_JS_CSS);
    }
    ...
    {
        register_nav_menu('menu-header', __('Menu header', 'bmc'));
    }
